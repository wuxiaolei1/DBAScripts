...
OR (OriginatingServer = 'LDSGENPRO1DBA03' AND JobName = 'APP DCS Find Mismatched WSS Proposals' AND OutOfSyncStep = 'Send Report') -- MAIL COMMENTED OUT
OR (OriginatingServer = 'LDSGENPRO1DBA03' AND JobName = 'APP DCS Find Mismatched WSS Proposals' AND OutOfSyncStep = 'Errored') -- MAIL COMMENTED OUT
OR (OriginatingServer = 'LDSGENPRO1DBA03' AND JobName = 'APP WSS Refresh' AND OutOfSyncStep = 'Fail notification (DocuTrieve)') -- MAIL COMMENTED OUT
OR (OriginatingServer = 'LDSGENPRO1DBA03' AND JobName = 'APP WSS Refresh' AND OutOfSyncStep = 'Fail notification (Refresh)') -- MAIL COMMENTED OUT
OR (OriginatingServer = 'LDSGENPRO1DBA03' AND JobName = 'APP WSS Writeback' AND OutOfSyncStep = 'Fail Notification') -- MAIL COMMENTED OUT
...
OR (JobName = 'APP DEBTREMEDY_LIVE CREATE_DCS_CLIENTS' AND (OriginatingServer = 'VM01GENPRODBA02' OR OutOfSyncServer = 'VM01GENPRODBA02') )
