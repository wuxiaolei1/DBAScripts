...
/****** Object:  Job [<SERVERNAME, NVARCHAR(128), >_WeeklyDefragmentIndexes]    Script Date: 07/24/2012 10:10:03 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 07/24/2012 10:10:04 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Defragment indexes]    Script Date: 07/24/2012 10:10:04 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Defragment indexes', 
		...
		@command=N'-- job step for SQL 2005 reindex
...
BEGIN
	...
	AND		[name] NOT IN (SELECT DatabaseName FROM @DB_Exceptions);
