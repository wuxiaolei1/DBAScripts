...
*/
SET NOCOUNT ON
Print 'Step 5 - Grant Permissions - CallTracking_Archive'

-- Re-establish multi-user access
ALTER DATABASE [CallTracking_Archive] SET MULTI_USER;

USE CallTracking_Archive
GO

exec sp_change_users_login 'Auto_Fix', 'CallTrackingUser'
