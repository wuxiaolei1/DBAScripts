...
*/
SET NOCOUNT ON
Print 'Step 5 - Grant Permissions - CreditReportsAudit'

-- Re-establish multi-user access
ALTER DATABASE [CreditReportsAudit] SET MULTI_USER;
...
IF NOT EXISTS (SELECT name FROM sys.database_principals WHERE name = N'CCCSNT\nonliveCreditBureau')
	CREATE USER [CCCSNT\nonliveCreditBureau] FOR LOGIN [CCCSNT\nonliveCreditBureau]

--Permissions
EXEC sp_addrolemember N'AuditRole', N'CCCSNT\nonliveCreditBureau'
