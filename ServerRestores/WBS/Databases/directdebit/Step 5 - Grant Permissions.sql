...
SET NOCOUNT ON
Print 'Step 5 - Grant Permissions - directdebit'

-- Re-establish multi-user access
USE [master]
GO

GRANT CONNECT SQL TO [CFLADMSYSTEM]
GO
ALTER LOGIN [CFLADMSYSTEM] ENABLE
GO

GRANT CONNECT SQL TO [CFLARCHIVE]
GO
ALTER LOGIN [CFLARCHIVE] ENABLE
GO

GRANT CONNECT SQL TO [CFLWEBSYSTEM]
GO
ALTER LOGIN [CFLWEBSYSTEM] ENABLE
GO

GRANT CONNECT SQL TO [directdebit]
GO
ALTER LOGIN [directdebit] ENABLE
GO
...
-- SQL Login Fixes
EXEC sp_change_users_login 'Auto_Fix', 'CFLADMSYSTEM'
EXEC sp_change_users_login 'Auto_Fix', 'CFLARCHIVE'
EXEC sp_change_users_login 'Auto_Fix', 'CFLWEBSYSTEM'
EXEC sp_change_users_login 'Auto_Fix', 'directdebit'
GO
...
/*
-- Update Passwords for Non-Production
UPDATE [directdebit].[dbo].[User]
SET [Password] = '', 
RND = ''
*/