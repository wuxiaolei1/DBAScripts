...
:on error exit
SET NOCOUNT ON
Print 'Step 5 - Grant Permissions - [NSB.Communications.Subscriptions]'

-- Re-establish multi-user access
ALTER DATABASE [NSB.Communications.Subscriptions] SET MULTI_USER;

USE [NSB.Communications.Subscriptions]
GO
