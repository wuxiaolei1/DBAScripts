...
:on error exit
SET NOCOUNT ON
Print 'Step 5 - Grant Permissions - [NSB.Colleague.Writer.Subscriptions]'

-- Re-establish multi-user access
ALTER DATABASE [NSB.Colleague.Writer.Subscriptions] SET MULTI_USER;

USE [NSB.Colleague.Writer.Subscriptions]
GO
