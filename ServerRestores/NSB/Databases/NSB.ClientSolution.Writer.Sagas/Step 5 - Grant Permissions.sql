...
:on error exit
SET NOCOUNT ON
Print 'Step 5 - Grant Permissions - [NSB.ClientSolution.Writer.Sagas]'

-- Re-establish multi-user access
ALTER DATABASE [NSB.ClientSolution.Writer.Sagas] SET MULTI_USER;

USE [NSB.ClientSolution.Writer.Sagas]
GO
