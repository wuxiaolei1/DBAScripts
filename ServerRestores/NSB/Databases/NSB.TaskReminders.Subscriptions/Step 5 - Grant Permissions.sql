...
:on error exit
SET NOCOUNT ON
Print 'Step 5 - Grant Permissions - [NSB.TaskReminders.Subscriptions]'

-- Re-establish multi-user access
ALTER DATABASE [NSB.TaskReminders.Subscriptions] SET MULTI_USER;

USE [NSB.TaskReminders.Subscriptions]
GO
