...
:on error exit
SET NOCOUNT ON
Print 'Step 5 - Grant Permissions - [NSB.TaskReminders.Writer.Timeouts]'

-- Re-establish multi-user access
ALTER DATABASE [NSB.TaskReminders.Writer.Timeouts] SET MULTI_USER;

USE [NSB.TaskReminders.Writer.Timeouts]
GO
