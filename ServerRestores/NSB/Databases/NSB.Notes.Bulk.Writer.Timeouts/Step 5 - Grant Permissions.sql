...
:on error exit
SET NOCOUNT ON
Print 'Step 5 - Grant Permissions - [NSB.Notes.Bulk.Writer.Timeouts]'

-- Re-establish multi-user access
ALTER DATABASE [NSB.Notes.Bulk.Writer.Timeouts] SET MULTI_USER;

USE [NSB.Notes.Bulk.Writer.Timeouts]
GO
