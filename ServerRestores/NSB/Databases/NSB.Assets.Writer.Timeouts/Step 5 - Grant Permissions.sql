...
:on error exit
SET NOCOUNT ON
Print 'Step 5 - Grant Permissions - [NSB.Assets.Writer.Timeouts]'

-- Re-establish multi-user access
ALTER DATABASE [NSB.Assets.Writer.Timeouts] SET MULTI_USER;

USE [NSB.Assets.Writer.Timeouts]
GO
...
EXECUTE sp_AddRoleMember 'db_ddladmin', 'CCCSNT\CIUser'
EXECUTE sp_AddRoleMember 'db_datareader', 'CCCSNT\CIUser'
EXECUTE sp_AddRoleMember 'db_datawriter', 'CCCSNT\CIUser'
GO