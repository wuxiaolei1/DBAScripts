...
:on error exit
SET NOCOUNT ON
Print 'Step 5 - Grant Permissions - [NSB.Communications.Writer.Timeouts]'

-- Re-establish multi-user access
ALTER DATABASE [NSB.Communications.Writer.Timeouts] SET MULTI_USER;

USE [NSB.Communications.Writer.Timeouts]
GO
