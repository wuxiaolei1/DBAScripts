...
:on error exit
SET NOCOUNT ON
Print 'Step 5 - Grant Permissions - [NSB.Colleague.Writer.Timeouts]'

-- Re-establish multi-user access
ALTER DATABASE [NSB.Colleague.Writer.Timeouts] SET MULTI_USER;

USE [NSB.Colleague.Writer.Timeouts]
GO
