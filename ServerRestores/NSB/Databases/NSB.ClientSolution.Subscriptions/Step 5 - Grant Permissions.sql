...
:on error exit
SET NOCOUNT ON
Print 'Step 5 - Grant Permissions - [NSB.ClientSolution.Subscriptions]'

-- Re-establish multi-user access
ALTER DATABASE [NSB.ClientSolution.Subscriptions] SET MULTI_USER;

USE [NSB.ClientSolution.Subscriptions]
GO
