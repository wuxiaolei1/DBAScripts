...
:on error exit
SET NOCOUNT ON
Print 'Step 5 - Grant Permissions - [NSB.ClientSolution.Writer.Timeouts]'

-- Re-establish multi-user access
ALTER DATABASE [NSB.ClientSolution.Writer.Timeouts] SET MULTI_USER;

USE [NSB.ClientSolution.Writer.Timeouts]
GO
