...
:on error exit
SET NOCOUNT ON
Print 'Step 5 - Grant Permissions - [NSB.DCSBudget.Writer.Timeouts]'

-- Re-establish multi-user access
ALTER DATABASE [NSB.DCSBudget.Writer.Timeouts] SET MULTI_USER;

USE [NSB.DCSBudget.Writer.Timeouts]
GO
