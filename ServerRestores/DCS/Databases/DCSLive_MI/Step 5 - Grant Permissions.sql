...
sqlcmd -S systems37\sql2005 -i "\\ldsfileproapp01\systems\Tech support shared data\SQL Server\ServerRestores\DCSSERVER\DCSLive\Step 5 - Grant Permissions.sql"
*/

:on error exit
SET NOCOUNT ON
Print 'Step 5 - Grant Permissions DCSLive_MI'

-- Re-establish multi-user access
ALTER DATABASE [DCSLive_MI] SET MULTI_USER;
