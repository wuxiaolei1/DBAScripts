...
:on error exit
SET NOCOUNT ON
PRINT 'Step 2 - Scramble Data - DMS'
...
-- Scramble Client Addresses if required
	...
	/* Truncate the new BusAdapter table created for COP in all environments except daily */
	...
	BEGIN
		...
		AND name <> 'ClientNotesExtensions'
		AND name <> 'TaskLogExtensions';
