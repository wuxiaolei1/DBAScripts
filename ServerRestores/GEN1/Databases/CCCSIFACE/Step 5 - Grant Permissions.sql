...
:on error exit
SET NOCOUNT ON
Print 'Step 5 - Grant Permissions - CCCSIFACE'

-- Re-establish multi-user access
ALTER DATABASE [CCCSIFACE] SET MULTI_USER;

USE CCCSIFACE
GO

--Rematch the SQL Logins
exec sp_change_users_login  'Auto_Fix', 'iFACE_User'
exec sp_change_users_login  'Auto_Fix', 'MIReportingAccess'
GO 
