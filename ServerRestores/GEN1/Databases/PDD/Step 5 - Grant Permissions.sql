...
:on error exit
SET NOCOUNT ON
Print 'Step 5 - Grant Permissions - PDD'

-- Re-establish multi-user access
ALTER DATABASE [PDD] SET MULTI_USER;

USE PDD
GO

--Rematch the SQL Logins
exec sp_change_users_login  'Auto_Fix', 'PddDbUser'
exec sp_change_users_login  'Auto_Fix', 'PDDUser'
exec sp_change_users_login  'Auto_Fix', 'DMSPDDRSLink'
