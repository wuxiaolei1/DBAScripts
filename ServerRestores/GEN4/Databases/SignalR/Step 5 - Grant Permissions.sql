...
SET NOCOUNT ON
Print 'Step 5 - Grant Permissions - SignalR'
...
GO
sp_addrolemember 'db_owner', 'CCCSNT\nonliveassetsrest'
GO
CREATE USER [CCCSNT\nonlivenotesrestserv] FOR LOGIN [CCCSNT\nonlivenotesrestserv] WITH DEFAULT_SCHEMA=[dbo]
GO
sp_addrolemember 'db_owner', 'CCCSNT\nonlivenotesrestserv'
GO
CREATE USER [CCCSNT\nonliveportal] FOR LOGIN [CCCSNT\nonliveportal] WITH DEFAULT_SCHEMA=[dbo]
GO
sp_addrolemember 'db_owner', 'CCCSNT\nonliveportal'
GO
CREATE USER [CCCSNT\nonliveappeventsrest] FOR LOGIN [CCCSNT\nonliveappeventsrest] WITH DEFAULT_SCHEMA=[dbo]
GO
sp_addrolemember 'db_owner', 'CCCSNT\nonliveappeventsrest'
GO
