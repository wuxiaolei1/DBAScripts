...
:on error exit
SET NOCOUNT ON
Print 'Step 5 - Grant Permissions - ClientHistoryAudit'

-- Re-establish multi-user access
ALTER DATABASE [ClientHistoryAudit] SET MULTI_USER;
...
/* users for COP - taken from $/COP/Database/ClientHistoryAudit/Trunk/Redgate Setup */
/* create logins */
USE [master]
GO
/**********************************************
