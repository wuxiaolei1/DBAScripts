...
SET NOCOUNT ON
Print 'Step 5 - Grant Permissions - DDValidationLogger'

-- Re-establish multi-user access
ALTER DATABASE [DDValidationLogger] SET MULTI_USER;

--Rematch the SQL Logins
exec sp_change_users_login 'Auto_Fix', 'cwsuser'
exec sp_change_users_login 'Auto_Fix', 'DDValidationLogger'
